	...
	public class QRMask
	{
		...
		public function evaluateSymbol(width:int,frame:Array):int
		{
			...
			for(var i:int=0; i<width; i++) {
				...
				{
					if((j > 0) && (i > 0)) {
						var b22:Number = frameY[j] & frameY[j-1] & frameYM[j] & frameYM[j-1];
						var w22:Number = frameY[j] | frameY[j-1] | frameYM[j] | frameYM[j-1];
