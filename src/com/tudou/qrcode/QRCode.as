package com.tudou.qrcode
{
	import flash.display.BitmapData;
	import flash.geom.Point;
	
	
	import com.tudou.qrcode.encode.QRRawCode;
	import com.tudou.qrcode.enum.QRCodeEncodeType;
	import com.tudou.qrcode.enum.QRCodeErrorLevel;
	import com.tudou.qrcode.input.QRInput;
	import com.tudou.qrcode.specs.QRSpecs;
	import com.tudou.qrcode.utils.FrameFiller;
	import com.tudou.qrcode.utils.QRCodeTool;
	...
	public class QRCode
	{
		...
		private function encodeMask(input:QRInput,mask:int):QRCode
		{
			...
			// remainder bits
			var c:int = QRSpecs.getRemainder(version);
			for(var j:int=0; j<c; j++) {
				var addr2:Point = filler.next();				
				filler.setFrameAt(addr2, 0x02);
			}
			frame = filler.frame;
