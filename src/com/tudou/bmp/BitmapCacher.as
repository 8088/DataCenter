package com.tudou.bmp 
{
	...
	public class BitmapCacher
	{
		 ...
		 * @return
		 */
		public static function cacheBitmap(source:DisplayObject, transparent:Boolean = true, fillColor:uint = 0x00000000, scale:Number = 1):BitmapFrameInfo
		{
		 ...
		 * @return
		 */
		public static function cacheBitmapFrameInfo(source:DisplayObject, transparent:Boolean = true, fillColor:uint = 0x00000000, scale:Number = 1):Vector.<BitmapFrameInfo>
		{
		 ...
		 * @return
		 */
		public static function cacheBitmapRotation(mc:DisplayObject, transparent:Boolean = true, fillColor:uint = 0x00000000):Vector.<BitmapFrameInfo>
		{
		 ...
		 * @return
		 */
		public static function cacheGridBitmap(source:DisplayObject, gridWidth:int, gridHeight:int, transparent:Boolean = true, fillColor:uint = 0x00000000, scale:Number = 1):GridBitmapDataInfo
		{
