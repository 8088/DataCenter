...
:: Android packaging
set AND_CERT_NAME="DataCenter"
set AND_CERT_PASS=1234
set AND_CERT_FILE=cert\DataCenter.p12
...
set IOS_PROVISION=cert\Mobile.mobileprovision
...
set APP_ID=com.gamevil.zenonia2

:: Output packages
set DIST_PATH=dist
set DIST_NAME=DataCenter

:: Debugging using a custom IP
set DEBUG_IP=10.155.9.10
